...
const seed = async ({}) => {
  ...
  const dayDataData = [
    {
      ...
      prompt:
        "Reflect on how you feel about your upcoming psychedelic journey.",
      audio: "meditation-1.mp3",
    },
    {
      title: "Day 2 Emotional Preparedness",
      prompt:
        "What are your expectations about the emotional depth of your upcoming psychedelic experience?",
      audio: "meditation-2.mp3",
    },
    {
      title: "Day 3 Exploring Your Reasons",
      prompt:
        "Why are you drawn to having this psychedelic experience at this time? Explore your motivations.",
      audio: "meditation-3.mp3",
    },
    {
      title: "Day 4 Insights from Research",
      prompt:
        "Reflect on the information you've gathered about the effects of psychedelics. What were the most important learning points for you?",
      audio: "meditation-4.mp3",
    },
    {
      title: "Day 5 Past Experiences and Influence",
      prompt:
        "Consider how your previous life experiences might shape this psychedelic journey.",
      audio: "meditation-5.mp3",
    },
    {
      title: "Day 6 Embracing the Unknown",
      prompt:
        "How do you feel about the unpredictable aspects of psychedelic experiences?",
      audio: "meditation-6.mp3",
    },
    {
      title: "Day 7 Therapeutic Insights",
      prompt:
        "Have you had emotionally significant and supportive conversations about the upcoming experience? What insights did you gain from these conversations?",
      audio: "meditation-7.mp3",
    },
    {
      title: "Day 8 Openness to the Journey",
      prompt:
        "How have you opened yourself to accepting whatever happens during the psychedelic experience?",
      audio: "meditation-8.mp3",
    },
    {
      title: "Day 9 Navigating Challenges",
      prompt:
        "Think about how you might deal with difficult moments during your upcoming psychedelic experience.",
      audio: "meditation-9.mp3",
    },
    {
      title: "Day 10 Ready to Let Go",
      prompt:
        "Reflect on your readiness to surrender to the psychedelic experience.",
      audio: "meditation-10.mp3",
    },
    {
      title: "Day 11 Psychological Readiness",
      prompt:
        "Describe the steps you're taking to mentally prepare for your psychedelic experience.",
      audio: "meditation-11.mp3",
    },
    {
      title: "Day 12 Physical Preparedness",
      prompt:
        "Describe your thoughts and feelings about how psilocybin might physically affect you during the experience, focusing on sensations, comfort, and any expected bodily changes.",
      audio: "meditation-12.mp3",
    },
    {
      title: "Day 13 Trust and Connection",
      prompt:
        "How are you building trust and connection with those who will be with you during the experience?",
      audio: "meditation-13.mp3",
    },
    {
      title: "Day 14 Safety and Trust",
      prompt:
        "Reflect on your knowledge and confidence in the safety of the substance and the environment.",
      audio: "meditation-14.mp3",
    },
    {
      title: "Day 15 Trusting Yourself",
      prompt:
        "Describe the things about you that give you confidence in your ability to navigate this experience?",
      audio: "meditation-15.mp3",
    },
    {
      title: "Day 16 Anticipating Change",
      prompt:
        "What changes do you anticipate this experience might bring in you?",
      audio: "meditation-16.mp3",
    },
    {
      title: "Day 17 Preparatory Practices",
      prompt:
        "Describe your experiences with preparatory practices like meditation, yoga, or journaling.",
      audio: "meditation-17.mp3",
    },
    {
      title: "Day 18 Planning Post-Experience",
      prompt:
        "Reflect on your plans and support system for after the psychedelic experience.",
      audio: "meditation-18.mp3",
    },
    {
      title: "Day 19 Developing Coping Strategies",
      prompt:
        "Reflect on the strategies you might use to manage challenging moments during the experience.",
      audio: "meditation-19.mp3",
    },
    {
      title: "Day 20 Involving Loved Ones",
      prompt:
        "How have you engaged or informed your family and friends about this journey?",
      audio: "meditation-20.mp3",
    },
    {
      title: "Day 21 Final Intentions",
      prompt:
        "Reflect on your past 20 days of journaling to define your clear, final intention for the psychedelic experience.",
  ...
  const dailyData = [
    ...
    },
    {
      ...
      date: "2024-01-16",
      user_id: 1,
      journal: "Worked on a challenging project today. Feeling accomplished!",
      meditation: true,
      mood_id: 11,
    },
    {
    ...
    },
    {
      ...
      date: "2024-01-18",
      user_id: 1,
      journal: "Met with a friend for coffee. It's always nice catching up.",
      meditation: true,
      mood_id: 31,
    },
    {
      ...
      date: "2024-01-19",
      user_id: 1,
      journal: "Started a new hobby today – painting. It's so therapeutic!",
      meditation: true,
      mood_id: 41,
    },
    {
